...
def load_assets():
    ...
    mv_trash = ["happyhour", "celebrate", "growl", "tailwhip", "leer", "splash", "confide", "camouflage", "bide", "refresh", "soak", "mudsport", "watersport", "snore", "present", "struggle","darkvoid","doubleshock","hyperspacefury","hyperspacehole","toxicthread","tackle","smog","aurawheel","burnup","belch","stuffcheeks","mindreader","poisongas","miracleeye","holdhands","mist","powder"]
    ...
    # 2. DRAFT MOSSE (CON FIX ANTI-DOPPIONI)
        ...
        if not st.session_state.options:
            ...
            if atk_moves:
                ...
                # 2. RIMUOVI l'attacco garantito dal pool restante prima di pescare le altre 3f

...
SPECIAL_TIER = [
    ...
    "Ogerpon", "Terapagos", "Pecharunt","Therian"
]
...
def load_assets():
    pk_pool = []; mv_db = {}
    pk_banned = ["ZACIAN", "ZAMAZENTA", "ETERNATUS", "MEWTWO", "RAYQUAZA", "KYOGRE", "GROUDON", "ARCEUS", "DIALGA", "PALKIA", "GIRATINA", "XERNEAS", "YVELTAL", "SOLGALEO", "LUNALA", "CALYREX", "KORAIDON", "MIRAIDON", "DEOXYS", "DARKRAI", "TERAPAGOS", "MAGEARNA", "CHI-YU", "CHIEN-PAO", "TING-LU", "WO-CHIEN","CELEBI","DARKRAI-MEGA", "HEATRAN-MEGA", "MAGEARNA-MEGA", "FLOETTE-MEGA"]

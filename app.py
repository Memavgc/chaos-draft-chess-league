...
def load_assets():
    ...
    mv_trash = ["happyhour", "celebrate", "growl", "tailwhip", "leer", "splash", "confide", "camouflage", "bide", "refresh", "soak", "mudsport", "watersport", "snore", "present", "struggle","darkvoid","doubleshock","hyperspacefury","hyperspacehole","toxicthread","tackle","smog","aurawheel","burnup","belch","stuffcheeks"]

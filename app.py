...
# --- CSS PER COLORI, CATEGORIE E CENTRATURA ---
st.markdown("""
<style>
    .type-badge {
    ...
    /* Centratura per i bottoni di scelta */
    .stButton > button {
        display: block;
        margin: 0 auto;
    }
...
# --- FUNZIONE SPRITE CON CENTRATURA FISSA ---
def display_sprite(name):
    ...
    # Il div ora forza la centratura totale
    st.markdown(f"""
        <div style="height:160px; display:flex; flex-direction:column; align-items:center; justify-content:center; text-align:center; width:100%;">
